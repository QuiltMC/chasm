...
public class ChasmAnnotationVisitor extends AnnotationVisitor {
    ...
    public void visit(String name, Object value) {
        if (value instanceof Object[]) {
            ...
            this.values.add(new WrapperValueNode(value));
        } else {
            MapNode valueNode = new LinkedHashMapNode();
            valueNode.put(NodeConstants.NAME, new WrapperValueNode(name));
            valueNode.put(NodeConstants.VALUE, new WrapperValueNode(value));
    ...
    public void visitEnum(String name, String descriptor, String value) {
        ...
        enumValueNode.put(NodeConstants.DESCRIPTOR, new WrapperValueNode(descriptor));
        enumValueNode.put(NodeConstants.VALUE, new WrapperValueNode(value));
    ...
    public AnnotationVisitor visitAnnotation(String name, String descriptor) {
        ...
        annotationValueNode.put(NodeConstants.DESCRIPTOR, new WrapperValueNode(descriptor));
